      ...
      axios.patch(`http://localhost:3030/users/${user._id}`,
        {
          ...
          seterrormdp("The new password must contains at least 8 charaters, one 1 uppercase character, 1 lowercase character, 1 numeric character and 1 special character")
